...
struct FillingData {
    static let data: [ContentType] = [
        ...
        .gallery(Gallery(coverImage: .init("samara-0"), title: "Samara", images: .init(base: "samara", count: 6))),
        .gallery(Gallery(coverImage: .init("tokio-0"), title: "Olympic", images: .init(base: "tokio", count: 6))),
        .story(Story(coverImage: .init("story-5"), title: .from("s5-title"), text: .from("s5-text"), paths: [.story5path1, .story5path2, .story5path1, .story5path2])),
